...
import { TemeContext } from "../../contexts/temeContext.jsx";

import "./Eader.css";

const Eader = () => {
  const { isDark, setIsDark } = useContext(TemeContext);
  function tolleContext() {
    setIsDark((prev) => !prev);
  }
  return (
    <div className="eader--container">
      <h1>todo</h1>
      <button
        style={{
